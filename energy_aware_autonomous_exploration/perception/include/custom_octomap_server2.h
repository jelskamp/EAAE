...
//     void runDefault();
//     bool saveOctomapServiceCb(std_srvs::Empty::Request& req, std_srvs::Empty::Response& res);
...
//     octomap::OcTree* m_octree {nullptr};
//     octomap::KeyRay m_keyRay;
//     octomap::OcTreeKey m_updateBBXMin;
//     octomap::OcTreeKey m_updateBBXMax;

//     std::string m_worldFrameId, m_baseFrameId, m_configFilename, m_filename, m_filePath;
//     geometry_msgs::Pose m_uavCurrentPose;
    
//     unsigned m_treeDepth, m_maxTreeDepth;
//     double m_resolution, m_probHit, m_probMiss, m_thresMin, m_thresMax, m_maxRange, m_totalVol;
//     bool m_pointCloudReceivedFlag {false}, m_compressMap {true};
